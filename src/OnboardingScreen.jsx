              ...
              <motion.div key="p1" variants={slideVariants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.3 }}>
                ...
                <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handlePaso1}
                  style={{ width: '100%', marginTop: 20, padding: '14px', borderRadius: 12, border: 'none',
                    background: 'rgba(255,255,255,0.08)', color: universidad === 'ufro' || universidad === 'uautonoma' || universidad === 'inacap' ? 'white' : colorPrincipal, fontSize: 16, fontWeight: 600, cursor: 'pointer', border: `1px solid ${colorPrincipal}60` }}>
                  Continuar →
                </motion.button>
              </motion.div>
            )}
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handlePaso2}
                    style={{ flex: 2, padding: '14px', borderRadius: 12, border: 'none',
                      background: 'rgba(255,255,255,0.08)', color: universidad === 'ufro' || universidad === 'uautonoma' || universidad === 'inacap' ? 'white' : colorPrincipal, fontSize: 15, fontWeight: 600, cursor: 'pointer', border: `1px solid ${colorPrincipal}60` }}>Continuar →</motion.button>
                </div>
              </motion.div>
            )}
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => setPaso(5)}
                    style={{ flex: 2, padding: '13px', borderRadius: 12, border: 'none',
                      ...
                      color: universidad === 'ufro' || universidad === 'uautonoma' || universidad === 'inacap' ? 'white' : colorPrincipal,
              ...
              <motion.div key="p5" variants={slideVariants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.3 }}>
                ...
                {notifEstado === 'ok' ? (
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                    ...
                    style={{ width: '100%', padding: '18px', borderRadius: 14, border: 'none',
                      background: 'rgba(255,255,255,0.08)', border: `1px solid ${colorPrincipal}60`,
                      color: universidad === 'ufro' || universidad === 'uautonoma' || universidad === 'inacap' ? 'white' : colorPrincipal, fontSize: 16, fontWeight: 700, cursor: notifEstado === 'activando' ? 'not-allowed' : 'pointer',
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                    ...
                    style={{ flex: 2, padding: '13px', borderRadius: 12, border: 'none',
                      background: 'rgba(255,255,255,0.08)', border: `1px solid ${colorPrincipal}60`,
                      color: universidad === 'ufro' || universidad === 'uautonoma' || universidad === 'inacap' ? 'white' : colorPrincipal, fontSize: 15, fontWeight: 600, cursor: loading ? 'not-allowed' : 'pointer' }}>
